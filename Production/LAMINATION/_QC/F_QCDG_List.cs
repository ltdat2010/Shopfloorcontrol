...
{
    public partial class F_QCDG_List : UC_Base
    {
        //Kiem tra xem click chon row tren grid chua
        bool gridViewRowClick = false;

        QuiCachDongGoi OBJ = new QuiCachDongGoi();
        QuiCachDongGoiBUS BUS = new QuiCachDongGoiBUS();
            ...
            Load += (s, e) =>
                {
                    ...
                    tbl_QuiCachDongGoiTableAdapter.Fill(sYNC_NUTRICIELDataSet.tbl_QuiCachDongGoi);
                  
                    gridControl1.DataSource = tbl_QuiCachDongGoiTableAdapter.Fill(sYNC_NUTRICIELDataSet.tbl_QuiCachDongGoi);                    
        ...
        private void ItemClickEventHandler_Add(object sender, EventArgs e)
        {
            ...
            //Update :  DELEGATE
            // Gọi form Details
            F_QCDG_Details F_LOC_Dtl = new F_QCDG_Details();
        ...
        private void ItemClickEventHandler_Edit(object sender, EventArgs e)
        {
            ...
            if (gridViewRowClick == true)
            {
                ...
                F_QCDG_Details F_LOC_Dtl = new Class.F_QCDG_Details();
                F_LOC_Dtl.OBJ = this.OBJ;
                F_LOC_Dtl.isAction = this.isAction;
                F_LOC_Dtl.myFinished += this.finished;
                F_LOC_Dtl.Show();
        ...
        private void ItemClickEventHandler_Delete(object sender, EventArgs e)
        {
            ...
            if (gridViewRowClick == true)
            {
                ...
                OBJ.QCDG = gridView1.GetFocusedRowCellValue("QCDG").ToString();

                DialogResult dlDel = XtraMessageBox.Show(" Bạn muốn xóa chỉ tiêu phân tích  : " + OBJ.QCDG + " ? ", "Xóa thông tin", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        public void Set4Object()
        {
            OBJ.ID = int.Parse(gridView1.GetFocusedRowCellValue("ID").ToString());
            OBJ.QCDG = gridView1.GetFocusedRowCellValue("QCDG").ToString();
            OBJ.QCDGDG = gridView1.GetFocusedRowCellValue("QCDGDG").ToString();
