...
namespace Production.Class
{
    public partial class F_NCTXN_List : UC_Base
    {
        ...
        private void ItemClickEventHandler_Add(object sender, EventArgs e)
        {
            ...
            //Update :  DELEGATE
            // Gọi form Details
            F_NCTXN_Details F_LOC_Dtl = new F_NCTXN_Details();
        ...
        private void ItemClickEventHandler_Edit(object sender, EventArgs e)
        {
            ...
            if (gridViewRowClick == true)
            {
                ...
                F_NCTXN_Details F_LOC_Dtl = new Class.F_NCTXN_Details();
                F_LOC_Dtl.OBJ = this.OBJ;
                F_LOC_Dtl.isAction = this.isAction;
                F_LOC_Dtl.myFinished += this.finished;
                F_LOC_Dtl.Show();
        ...
        private void ItemClickEventHandler_Delete(object sender, EventArgs e)
        {
            ...
            if (gridViewRowClick == true)
            {
                ...
                OBJ.NCTXN = gridView1.GetFocusedRowCellValue("NCTXN").ToString();

                DialogResult dlDel = XtraMessageBox.Show(" Bạn muốn xóa phương pháp thử  : " + OBJ.NCTXN + " ? ", "Xóa thông tin", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        public void Set4Object()
        {
            OBJ.ID = int.Parse(gridView1.GetFocusedRowCellValue("ID").ToString());
            OBJ.NCTXN = gridView1.GetFocusedRowCellValue("NCTXN").ToString();
            OBJ.NCTXNDG = gridView1.GetFocusedRowCellValue("NCTXNDG").ToString();
