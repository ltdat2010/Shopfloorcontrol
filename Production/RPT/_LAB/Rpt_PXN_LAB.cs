...
namespace Production.RPT._LAB {
    ...
    public class Rpt_PXN_LAB : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Production.RPT._LAB.Rpt_PXN_LAB.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRpt_PXN_LAB : Component, ICachedReport {
        
        public CachedRpt_PXN_LAB() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Rpt_PXN_LAB rpt = new Rpt_PXN_LAB();
            rpt.Site = this.Site;
            return rpt;
        }
