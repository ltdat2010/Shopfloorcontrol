...
{
    public partial class R_IV_List : frm_Base
    {
        private DataTable dt_IV_List = new DataTable();
        ...
        public R_IV_List()
        {
            ...
            Load += (s, e) =>
            {
                //dt_IV_List = sP_tbl_ItemTableAdapter.Fill(sYNC_NUTRICIELDataSet.SP_tbl_Item);
                //XtraMessageBox.Show("Path : " + Path);
                dt_IV_List.WriteXml(Path + "/Xml/dt_IV_List.xml", System.Data.XmlWriteMode.IgnoreSchema);
