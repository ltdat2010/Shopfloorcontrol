...
{
    public partial class R_MYCOTOXIN_RESULT_LAB_ANALYSISREPORT : frm_Base
    {
        /// <summary>
        /// DELEGATE
        /// </summary>
        ...
        public R_MYCOTOXIN_RESULT_LAB_ANALYSISREPORT()
        {
            ...
            Load += (s, e) =>
            {
                ...
                dt_MYCOTOXIN_RESULT_Lines_AnalysisReport_LAB.WriteXml(XmlPath + "/dt_MYCOTOXIN_RESULT_Lines_AnalysisReport_LAB.xml", System.Data.XmlWriteMode.IgnoreSchema);
