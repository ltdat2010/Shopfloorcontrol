...
{
    public partial class R_BaoCaoCongNo_LAB : frm_Base
    {
        /// <summary>
        /// DELEGATE
        /// </summary>
        ...
        {
            string filename = @"D:\\BaoCaoCongNo_" + FrDate.ToString().Substring(0, 10).Replace("/", "") + "_" + ToDate.ToString().Substring(0, 10).Replace("/", "") + ".xls";
